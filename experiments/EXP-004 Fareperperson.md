...
| Поле                | Значение                                                                                                                                                  |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Эксперимент         | EXP-004 — Рассчет точной цены билета!                                                                                                                     |
| Гипотеза            | if создать группы по номеру билета, then точнее можно оценить стоимость билета на человека , because это лучше отражает действительноть, ценность билета! |
| Одно изменение      | Создать переменную TicketGroup, которая будет группировать билеты по номеру билета,и рассчитать FarePerPerson относительно EXP003 больше ничего не менять |
...
| Цепочка             | EXP-001 → [[experiments/EXP-002 AGE_Experiment.md\|EXP-002]] → [[experiments/EXP-003 Family Size.md\|EXP-003]] → EXP-004                                  |
| Код эксперимента    | [[src/ml_project/experiments/exp_004_fareperperson.py\|ml_project.experiments.exp_004_fareperperson]]                                                     |
| Hash кода           | 2cd798d8b76c…                                                                                                                                             |
...
| --------- | ----------------- | ------------: | ------------: | ------: |
| primary   | accuracy          |       -0.0045 |        0.0050 |   False |
| guardrail | Balanced accuracy |       -0.0047 |        0.0000 |   False |
| guardrail | Recall            |       -0.0058 |       -0.0100 |    True |
| guardrail | F1                |       -0.0060 |        0.0000 |   False |
...
| candidate          | accuracy          | maximize    | 0.8160 ± 0.0158 |    0.8204 |       -0.0045 |
| candidate          | Balanced accuracy | maximize    | 0.7971 ± 0.0222 |    0.8018 |       -0.0047 |
| candidate          | Precision         | maximize    | 0.7855 ± 0.0145 |    0.7916 |       -0.0061 |
| candidate          | Recall            | maximize    | 0.7162 ± 0.0521 |    0.7220 |       -0.0058 |
| candidate          | F1                | maximize    | 0.7484 ± 0.0295 |    0.7544 |       -0.0060 |
| candidate          | ROC-AUC           | maximize    | 0.8602 ± 0.0224 |    0.8612 |       -0.0011 |

## Метрика: accuracy

![[assets/experiments/EXP-004/metric-primary-accuracy.png]]
...
| candidate          | 0.8160 | 0.0158 | 0.7989 | 0.8371 |    0.8204 |       -0.0045 |
...
![[assets/experiments/EXP-004/metric-secondary_1-balanced-accuracy.png]]
...
| candidate          | 0.7971 | 0.0222 | 0.7735 | 0.8271 |    0.8018 |       -0.0047 |
...
![[assets/experiments/EXP-004/metric-secondary_2-precision.png]]
...
| candidate          | 0.7855 | 0.0145 | 0.7619 | 0.8000 |    0.7916 |       -0.0061 |
...
![[assets/experiments/EXP-004/metric-secondary_3-recall.png]]
...
| candidate          | 0.7162 | 0.0521 | 0.6471 | 0.7826 |    0.7220 |       -0.0058 |
...
![[assets/experiments/EXP-004/metric-secondary_4-f1.png]]
...
| candidate          | 0.7484 | 0.0295 | 0.7154 | 0.7883 |    0.7544 |       -0.0060 |
...
![[assets/experiments/EXP-004/metric-secondary_5-roc-auc.png]]
...
| candidate          | 0.8602 | 0.0224 | 0.8366 | 0.8850 |    0.8612 |       -0.0011 |
...
- [[artifacts/experiments/exp_004_v1/cv_fold_scores.csv|cv_fold_scores.csv]]
- [[artifacts/experiments/exp_004_v1/cv_summary.csv|cv_summary.csv]]
- [[artifacts/experiments/exp_004_v1/metadata.json|metadata.json]]
