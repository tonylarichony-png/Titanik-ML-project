...
EXPERIMENT = ExperimentSettings(
    ...
    experiment_title='Рассчет точной цены билета и лог преобразование',
    experiment_note=Path(
        "experiments/EXP-005 Log1Pfareperperson.md"
    ),
...
def prepare_candidate_data(
    ...
    frame["FarePerPerson"]=np.log1p(frame["Fare"]/TicketGroupSize)
    groups["numeric"] = [
            *groups.get("numeric", []),
            "FarePerPerson",
        ]
